...
public class BlockFakeCake extends Block {
	...
	@Override
	public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos blockpos, PlayerEntity playerentity, Hand hand, BlockRayTraceResult blockraytrace) {

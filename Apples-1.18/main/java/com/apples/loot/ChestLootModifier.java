...
public class ChestLootModifier extends LootModifier {
	...
	public static final DeferredRegister<GlobalLootModifierSerializer<?>> GLOBAL_LOOT_MODIFIER = DeferredRegister.create(Keys.LOOT_MODIFIER_SERIALIZERS, Main.MODID);

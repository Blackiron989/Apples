...
public class Config {
	...
	public static final class Holder {
		...
		public static boolean ultimateAppleEffect;
		
		public static void load() {
			
			//rubyGeneration = SERVER.rubyGeneration.get();
			//bedrockGeneration = SERVER.bedrockGeneration.get();
			ultimateAppleEffect = SERVER.ultimateAppleEffect.get();
			...
			Main.LOGGER.info("Apples+ ultimate apple effect config value = " + ultimateAppleEffect);

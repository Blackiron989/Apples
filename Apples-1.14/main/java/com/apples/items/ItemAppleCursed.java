			...
			switch(i) {
				...
				case 1:
					...
					if(world.canBlockSeeSky(livingentity.getPosition())) {
						...
						LightningBoltEntity lightningboltentity = new LightningBoltEntity(world, livingentity.posX, livingentity.posY, livingentity.posZ, false);
				...
				case 2:
					...
					int height = (int)livingentity.posY;
					
					while(height > 1) {
						
						BlockPos blockpos = new BlockPos(livingentity.posX, height, livingentity.posZ);

	...
	public ItemStack onItemUseFinish(ItemStack itemstack, World world, LivingEntity livingentity) {
		...
		if(!world.isRemote) {
			...
			if(rand > 8) {
				...
				chestminecartentity.setPosition(livingentity.getPosX(), livingentity.getPosY(), livingentity.getPosZ());
				...
				hopperminecartentity.setPosition(livingentity.getPosX(), livingentity.getPosY(), livingentity.getPosZ());
				...
				furnaceminecartentity.setPosition(livingentity.getPosX(), livingentity.getPosY(), livingentity.getPosZ());
				...
				tntminecartentity.setPosition(livingentity.getPosX(), livingentity.getPosY(), livingentity.getPosZ());
				...
				minecartentity.setPosition(livingentity.getPosX(), livingentity.getPosY(), livingentity.getPosZ());

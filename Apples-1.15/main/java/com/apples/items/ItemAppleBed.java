	...
	public ItemStack onItemUseFinish(ItemStack itemstack, World world, LivingEntity livingentity) {
		...
		if(!world.isRemote) {
			...
			if(world.getDimension().isSurfaceWorld()) {
				...
				world.createExplosion((PlayerEntity)null, DamageSource.causeExplosionDamage(livingentity), livingentity.getPosX(), livingentity.getPosY(), livingentity.getPosZ(), 3.0F, true, null);
